...
ace.define('ace/mode/python_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror'], function(require, exports, module) {
...
var PythonWorker = exports.PythonWorker = function(sender) {
    ...
    this.setTimeout(200);
    importScripts("/bower_components/skulpt/skulpt.min.js");
};
...
(function() {
    ...
    this.onUpdate = function() {
        ...
        try {
            Sk.resetCompiler();
            var result = Sk.compile(value, '__main__');
        } catch (e) {
